...
class MainController extends Controller {
    ...
    {
        $this->email->sender('cassius@gmail.com', 'Activity');
    ...
    {
        $fullContent = "Hello, <br><br>This is a sample email.<br>These are the email's contents: <br>" . $content; // paltan mo to para iba ung ityura pag nag upload na
